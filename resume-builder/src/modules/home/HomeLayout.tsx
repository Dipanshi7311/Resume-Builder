  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1] }} className="scroll-smooth">
      <nav className="sticky top-0 z-20 h-14 w-full bg-resume-800 flex py-2.5 px-4 xl:px-60 items-center shadow-level-8dp">
        <Link href="/">
          <Image src={'/icons/icons8-resume-100.png'} alt="logo" height="36" width="36" />
        </Link>
        <div className="flex-auto flex justify-between items-center ml-5">
          ...
          <NavBarActions>
            ...
            <a href={'https://github.com/Dipanshi7311'} target="_blank" rel="noopener noreferrer">
        ...
        <div className="mx-6 md:mx-40 xl:mx-60 mb-6">
          ...
          >
            <div className="col-span-12 sm:col-span-4">
              <motion.img
                id="resume-3d"
                src="/icons/icons8-resume-100.png"
                alt="resume-3d"
            ...
            <div className="col-span-12 sm:col-span-8">
              ...
              <div className="flex mb-10">
                ...
                <p className="text-lg ml-3 text-resume-800">
                  &ldquo;“Memory is deceptive because it is colored by today's events.”&rdquo;
                  <br />
                  —Albert Einstien
                </p>
              </div>
        ...
        >
          <div className="grid grid-cols-12 items-center text-center">
            ...
            <div className="col-span-12 lg:col-span-3 mx-auto flex flex-col items-center gap-2">
              ...
              <div>
                <a href="https://github.com/Dipanshi7311" target="_blank" rel="noreferrer">
